...
// import SvgPathAnimation from './path-animation';
// import Circle from './circle';

// interface MultiInputAnimationProps {
//   className?: string;
// }

// export default function MultiInputAnimation({ className }: MultiInputAnimationProps) {
//   const containerRef = useRef<HTMLDivElement>(null);
//   const div1Ref = useRef<SVGSVGElement>(null);
//   const div2Ref = useRef<SVGSVGElement>(null);
//   const div3Ref = useRef<SVGSVGElement>(null);
//   const div4Ref = useRef<SVGSVGElement>(null);
//   const div5Ref = useRef<SVGSVGElement>(null);
//   const div6Ref = useRef<SVGSVGElement>(null);
//   const div7Ref = useRef<SVGSVGElement>(null);

//   return (
//     <div
//       ref={containerRef}
//       className={cn(
//         "relative flex w-full items-center justify-center overflow-hidden rounded-lg border bg-background p-10 md:shadow-xl dark:shadow-[#090909]",
//         className
//       )}
//     >
//       {/* Gradient Line */}
//       <div
//         className="absolute right-5 top-0 h-px w-1/2 bg-gradient-to-l from-transparent via-white/30 via-10% to-transparent"
//       />
//       {/* Main Component */}
//       <div
//         className="flex h-full w-full flex-row justify-between gap-10 max-w-lg items-center"
//       >
...
//       <SvgPathAnimation containerRef={containerRef} fromRef={div1Ref} toRef={div6Ref} />
//       <SvgPathAnimation containerRef={containerRef} fromRef={div2Ref} toRef={div6Ref} />
//       <SvgPathAnimation containerRef={containerRef} fromRef={div3Ref} toRef={div6Ref} />
//       <SvgPathAnimation containerRef={containerRef} fromRef={div4Ref} toRef={div6Ref} />
//       <SvgPathAnimation containerRef={containerRef} fromRef={div5Ref} toRef={div6Ref} />
//       <SvgPathAnimation containerRef={containerRef} fromRef={div6Ref} toRef={div7Ref} />
//     </div>
//   );
// }
